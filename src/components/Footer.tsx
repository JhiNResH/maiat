      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <img src="/logo-light.png" alt="MAIAT" className="w-6 h-6 block dark:hidden object-contain" />
            <img src="/logo-dark.jpg" alt="MAIAT" className="w-6 h-6 hidden dark:block object-contain" />
